...
| <a name="module_eventhub_setup_infrastructure"></a> [eventhub\_setup\_infrastructure](#module\_eventhub\_setup\_infrastructure) | ./modules/infrastructure/eventhub |  |
...
| <a name="input_subscription_id"></a> [subscription\_id](#input\_subscription\_id) | Azure subscription ID where apply the infrastructure | `string` | n/a | yes |
